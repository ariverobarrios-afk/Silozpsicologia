...
export default function Ansiedad() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    message: "Me gustaría solicitar información sobre terapia para la ansiedad.",
  });
  ...
  useEffect(() => {
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Terapia Online para Ansiedad | Sesión de Valoración Inicial');
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await sendContact({
        ...
        sessionType: "ansiedad",
      });
      AnalyticsEvents.submitContactForm("ansiedad");
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-foreground/70 mb-8">
              Recupera el control de tu vida. Terapia especializada en ansiedad desde la comodidad de tu hogar.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                "Sensación de nerviosismo o tensión permanente",
                "Dificultad para concentrarte o relajarte",
                "Problemas para dormir o insomnio",
                "Palpitaciones, sudoración o temblores",
                "Sensación de falta de aire o opresión en el pecho",
            ...
            <p className="text-center mt-8 text-lg text-foreground/70">
              Si has experimentado varios de estos síntomas, <strong>no estás solo</strong>. La ansiedad es tratable y puedo ayudarte.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-accent/20">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Cómo puedo ayudarte a superar la ansiedad
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-foreground/70">
                  Trabajamos con objetivos claros y herramientas prácticas que podrás aplicar desde la primera sesión.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Proceso de Terapia para la Ansiedad
            </h2>
            <div className="space-y-8">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    Conoceremos tu situación actual, tus síntomas y qué te ha traído hasta aquí. Un espacio para entender tu punto de partida.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    Identificamos las causas de tu ansiedad y diseñamos un plan de tratamiento adaptado a ti.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    Trabajamos juntos con técnicas probadas: gestión emocional, reestructuración cognitiva, mindfulness y más.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    Te acompaño en el proceso hasta que recuperes el control y te doy herramientas para prevenir recaídas.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <blockquote className="text-xl md:text-2xl italic text-foreground/80 mb-6">
              "Después de meses sufriendo ansiedad sin saber qué hacer, encontré en Silvia una profesional que me ayudó a entender qué me pasaba y a recuperar mi vida. Hoy puedo decir que la ansiedad ya no me controla."
            </blockquote>
            <p className="text-foreground/60">— M.G., paciente de terapia online</p>
          </div>
        </div>
      </section>
